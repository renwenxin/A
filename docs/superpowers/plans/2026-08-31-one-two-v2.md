...
def test_auction_ratio_tiers():
    ...
    assert grade_auction_ratio(12.0, 40.0, w)['level'] == 'extreme'    # 12% ≥10
    assert grade_auction_ratio(5.5, 40.0, w)['level'] == 'high'        # 5.5% ≥5
    assert grade_auction_ratio(3.2, 40.0, w)['level'] == 'mid'         # 3.2% ≥3
    assert grade_auction_ratio(1.0, 40.0, w)['level'] == 'low'         # <3
